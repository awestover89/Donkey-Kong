Public Class GameAttempt : Inherits Form
    ...
    Private Sub GameAttempt_Paint(ByVal sender As Object, ByVal e As PaintEventArgs) Handles MyBase.Paint
    ...
    Private Sub GameAttempt_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyDown
        _player.KeyDown(e.KeyCode)
    End Sub

    Private Sub GameAttempt_KeyUp(ByVal sender As Object, ByVal e As KeyEventArgs) Handles MyBase.KeyUp
        _player.KeyUp(e.KeyCode)
    End Sub

    Private Sub GameAttempt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub GameAttempt_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        'dkPBox.Show()
        '_player.Draw()
        _dk.Draw()
        'For i = 0 To 14
